...
# compare two files
ref_path = '/Users/xuel12/Documents/Projects/seq2spec/CoSpred/data/heladigest/train.hdf5'

f1 = h5py.File(data_path, 'r')
f2 = h5py.File(ref_path, 'r')
list(f1.keys())
list(f2.keys())
dataset_list1 = list(f1.keys())
for dset_name in dataset_list1:
    print(dset_name)
    print(f1[dset_name].shape)
    print(f1[dset_name][:6])
dataset_list2 = list(f2.keys())
for dset_name in dataset_list2:
    print(dset_name)
    print(f2[dset_name].shape)
    print(f2[dset_name][:6])
