...
data_path = constants_gcp.DATA_DIR + 'hdf5/traintest_hcd.hdf5'
subdata_path = constants_gcp.DATA_DIR + 'traintest_hcd_4m.hdf5'
...
#%%
# examine weights
read_hdf5(constants_gcp.EXAMPLE_DIR + 'weight_32_0.10211.hdf5')
f = h5py.File(constants_gcp.EXAMPLE_DIR + 'weight_32_0.10211.hdf5', 'r')
