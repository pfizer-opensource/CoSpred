...
#Shivani's local path
BASE_PATH = "C:/Users/tiwars46/PycharmProjects/prosit_PfizerRD/"
DATA_DIR = BASE_PATH + "finaldatafolder/"
DATA_PATH = BASE_PATH + "data/ex.hdf5"
MODEL_SPECTRA = BASE_PATH+"local_training/model_spectra_4rawfiles/"
MODEL_IRT = BASE_PATH+"local_training/model_irt/"
OUT_DIR = BASE_PATH+"local_training/prediction/"
MODEL_DIR = MODEL_SPECTRA
PLOT_DIR = BASE_PATH + "local_training/examples/plot"
