...
def generateHDF5_transformer(usimgffile, reformatmgffile, dbsearch_df, csvfile, contrastcsvfile):
    ...
    dataset = {
        ...
        "masses_raw": io_cospred.get_2darray(mzs_df['masses']).astype(np.float32),
        ...
        "raw_file": mzs_df['raw_file'].astype('S60'),
        ...
        "modified_sequence": mzs_df['modified_sequence'].astype('S60'),
