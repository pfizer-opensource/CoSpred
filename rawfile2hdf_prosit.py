...
def main():    
    ...
    parser.add_argument('-m', '--mgffile', default=constants_location.MGF_PATH, help='raw file MGF')
    parser.add_argument('-z', '--mzmlfile', default=constants_location.MZML_PATH, help='raw file mzML')
    parser.add_argument('-p', '--psmfile', default=constants_location.PSM_PATH, help='PSM file')
